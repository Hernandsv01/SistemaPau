...
public class ConfirmMessage extends javax.swing.JFrame {
    ...
    public void setER(EditorRegistro ER){
        this.ER = ER;
    }
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        switch (type) {
            ...
            case E_CLASESEMANAL:{
                ...
                VCS.dispose();
                ECS.dispose();
                new PopupMessage("Clase eliminada con exito", Color.GREEN).setVisible(true);
                break;
            }
            case E_REGISTROCLASE:{
                String statement1 = "DELETE FROM `registropresentes` WHERE `id_registroclase` = '" + ID + "'";
                DBConnection.getInstance().modificationStatement(statement1);
                String statement2 = "DELETE FROM `razonesausencias` WHERE `id_registroclase` = '" + ID + "'";
                DBConnection.getInstance().modificationStatement(statement2);
                String statement3 = "DELETE FROM `ausencias` WHERE `id_registroclase` = '" + ID + "'";
                DBConnection.getInstance().modificationStatement(statement3);
                String statement4 = "DELETE FROM `registroclases` WHERE `ID` = '" + ID + "'";
                DBConnection.getInstance().modificationStatement(statement4);
                dispose();
                ER.dispose();
                new PopupMessage("Registro eliminado con exito", Color.GREEN).setVisible(true);
            }
        }
